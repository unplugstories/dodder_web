...
int main(int argc, char *argv[], char *window_name) {
	...
	{		
		...
		cout << endl << endl << endl << "Using " << imageName1 << " and " << imageName2<<" fileNumber "<<fileNumber << endl;
		...
		*/
		...
		cout<<"MatchingPoints object created ";
...
void nearest(Mat image1, Mat image2) 
{
	...
	int minHessian = 1000;
	//SurfFeatureDetector 
//	SURFDetector detector(minHessian);
  ...
  Ptr<SURF> detector = SURF::create( minHessian );
   ...
   cv::BFMatcher matcher;
	...
	//if(descriptors1.type == descriptors2.type &&  descriptors1.cols == descriptors1.cols)
...
void downsample(Mat *image) 
{
	...
	//cv::resize(image, image, cv::Size(180,180));
	int maxRows = 2400;
	int maxCols = 2800;
	...
	cout<<"down sized completed"<< endl;
