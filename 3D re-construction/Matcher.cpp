...
Matcher::Matcher() : ratio(0.65f), refineF(true),confidence(0.99), distance(3.0) 
{
		...
		//extractor = SURF::create();
		 ...
		 extractor= SURF::create();//extractor= new cv::SurfDescriptorExtractor();
}
...
{
	cout<<"Matcher match start ...\n";

		bool enoughMatches = false;
		// 1a. Detection of the SURF features
		detector->detect(image1,keypoints1);
		detector->detect(image2,keypoints2);
		cout<<"Matcher settting detector\n";
		// 1b. Extraction of the SURF descriptors
		cv::Mat descriptors1, descriptors2;
		extractor->compute(image1,keypoints1,descriptors1);
		extractor->compute(image2,keypoints2,descriptors2);
		cout<<"Matcher settting extractor\n";
		...
		cout<<"Creatting matcher with BFMatcher\n"<<endl;
		...
		matcher.knnMatch(descriptors1,descriptors2,
			...
			5); // return 2 nearest neighbours
		// from image 2 to image 1
		// based on k nearest neighbours (with k=2)
		cout<<"Matcher with kNN\n"<<endl;
